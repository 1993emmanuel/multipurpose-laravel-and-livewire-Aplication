                            ...
                            {{-- form --}}
                                ...
                                <div class="form-group">
                                  ...
                                  <input 
                                    ...
                                    aria-describedby="emailHelp" placeholder="Enter email" wire:model.defer="state.email">
                                    @error('email')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <input 
                                    type="password" class="form-control @error('password') is-invalid @enderror " id="password" 
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="password" class="form-control" 
                                    ...
                                    placeholder="Password" wire:model.defer="state.password_confirmation">
                                </div>
                        </div>
